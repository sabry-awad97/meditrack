...
/// Medicine form entity - represents pharmaceutical dosage forms
...
pub struct Model {
    ...
    /// Form code (e.g., "CAPLET", "SYRUP") - VARCHAR(50) (unique)
    #[sea_orm(column_type = "String(StringLen::N(50))", unique)]
    pub code: String,

    /// English name - VARCHAR(100)
    #[sea_orm(column_type = "String(StringLen::N(100))")]
    pub name_en: String,

    /// Arabic name - VARCHAR(100)
    #[sea_orm(column_type = "String(StringLen::N(100))")]
    pub name_ar: String,

    /// Display order for UI sorting - INTEGER
    pub display_order: i32,

    /// Whether form is active - BOOLEAN
    pub is_active: bool,
...
pub enum Relation {
    /// One-to-many: Medicine form has many inventory items
